<template>
    <div class="w-full h-screen flex justify-center items-center">
        <form action="">
            <main class="w-full  flex items-center bg-gray-100 rounded-lg font-mono">
                ...
                <div class="w-full sm:w-1/2 md:w-1/3 p-10 grid grid-cols-1 space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <button
                            class="w-full focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-blue-300 hover:bg-blue-400 hover:shadow-lg">Login</button>
                    </div>
                    <a href="#" class="flex justify-around">
                        ...
                        <span class="hover-underline">I don't have an account</span>
                    </a>
                </div>
                <div class="hidden sm:inline sm:w-1/2 md:w-2/3 p-10 md:p-20">
                    <svg id="f795efda-d52b-464f-8ed0-c83c27181fc6" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="754" height="750.35999"
                        viewBox="0 0 754 750.35999">
                        <defs>
                            <linearGradient id="b13d5aa8-7d59-4aa5-8b0c-a1087af90b05" x1="632.9307" y1="457.00246"
                                x2="719.74066" y2="457.00246" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="#fff" />
                                <stop offset="1" stop-color="#fff" stop-opacity="0.3" />
                            </linearGradient>
                            <linearGradient id="b216fe78-eea0-4fe3-b1f5-9d415c27bb0d" x1="578.9307" y1="243.00246"
                                x2="665.74066" y2="243.00246" xlink:href="#b13d5aa8-7d59-4aa5-8b0c-a1087af90b05" />
                        </defs>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-223 -74.82001)" opacity="0.8"
                        ...
                        <polygon
                            ...
                            fill="#2f2e41" />
                        <path d="M872.38,320.07v392.4a378.72351,378.72351,0,0,1-82.45,65.08V320.07Z"
                            transform="translate(-223 -74.82001)" fill="#2f2e41" />
                        ...
                        <g opacity="0.4">
                            <path d="M796.93,320.07h-7V777.55q3.52736-2.06131,7-4.20514Z"
                        ...
                        <path
                            ...
                            transform="translate(-223 -74.82001)" fill="#8b5cf6" />
